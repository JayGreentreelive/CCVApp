	...
	partial class LoginViewController : UIViewController
	{
        ...
        public void TryLogin()
        {
                ...
                string.IsNullOrEmpty( PasswordField.Text ) == false )
            {
                ...
                Rock.Mobile.Network.RockApi.Instance.Login( UsernameField.Text, PasswordField.Text, LoginComplete );
            }
        }
        ...
        public void LoginComplete( System.Net.HttpStatusCode statusCode, string statusDescription )
        {
            switch( statusCode )
            {
                ...
                {
                    Rock.Mobile.Network.RockApi.Instance.GetProfile( null, ProfileComplete );
                    break;
                }
                    ...
                    LoginSuccessfulTimer.Elapsed += (object sender, System.Timers.ElapsedEventArgs e) => 
                        {
                            ...
                            Rock.Mobile.Threading.UIThreading.PerformOnUIThread( delegate { Springboard.LoginWantsResign( ); } );
                        };
