...
namespace iOS
{
	partial class GIveMainPageUIViewController : TaskUIViewController
	{
        ...
        public override void ViewDidLoad()
        {
            ...
            ControlStyling.StyleButton( GiveButton, CCVApp.Shared.Strings.GiveStrings.ButtonLabel, ControlStylingConfig.Font_Regular, ControlStylingConfig.Medium_FontSize );
