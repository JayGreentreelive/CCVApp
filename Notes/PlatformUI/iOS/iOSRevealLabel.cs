...
namespace Notes
{
    namespace PlatformUI
    {
        ...
        public class UnderlineUIView : UIView
        {
            public override void Draw(RectangleF rect)
            {
                ...
                using( CGContext context = UIGraphics.GetCurrentContext() )
                {
                    ...
                    CGGradient gradiant = new CGGradient( CGColorSpace.CreateDeviceRGB(), new CGColor[] { UIColor.Black.CGColor, UIColor.White.CGColor, UIColor.Black.CGColor });
        ...
        public class iOSRevealLabel : iOSLabel
        {
            ...
            {
                Scale = Math.Max(.01f, fadeAmount * MaxScale);
                ApplyMaskScale( Scale );
            }

            public override void AnimateToFade( float fadeAmount )
            {
                fadeAmount = Math.Max(.01f, fadeAmount * MaxScale);
